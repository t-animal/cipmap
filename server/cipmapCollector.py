...
class Collector:
        ...
        def toString(self):
                ...
                string += "(Information on {} users was last gathered {} ago{})\n".\
                                format(self.userInformation.count("\n"), self._printTimeDelta(tdelta), outdated)
                
                string += self.userInformation + "\n"
        ...
        def collect(self):
                ...
                try:
                        ...
                        self.userInformation = self.userInformation[4:]
                        if len(self.userInformation) > 0:
                                self.userInformation = self.userInformation.replace("\0", "\n")
